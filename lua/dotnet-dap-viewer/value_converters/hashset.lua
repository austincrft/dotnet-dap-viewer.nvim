...
return {
  ...
  extract = function(_, vars, var_path, _, cb)
    ...
    require("dotnet-dap-viewer.dap").fetch_variables(entries, 1, function(slot_entries)
      ...
      cb(result, require("dotnet-dap-viewer.pretty_printers.list").pretty_print(result))
    end)
  end,
}
