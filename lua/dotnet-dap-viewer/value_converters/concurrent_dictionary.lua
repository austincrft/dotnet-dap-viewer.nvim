...
return {
  ...
  extract = function(_, vars, var_path, _, cb)
    ...
    require("dotnet-dap-viewer.dap").fetch_variables(tables_ref, 1, function(tables_children)
      ...
      require("dotnet-dap-viewer.dap").fetch_variables(buckets_ref, 2, function(bucket_entries)
        local result = {}
        local added = 0
        ...
        cb(result, require("dotnet-dap-viewer.pretty_printers.kv-pair-list").pretty_print(result))
      end)
    end)
  end,
}
